    ...
    <div className="w-1/4 bg-gray-200 p-4 text-left">
      ...
      <ul className="space-y-4">
        ...
        <div className="ml-4 space-y-2">
         ...
         {/* จัดการผู้ใช้งาน */}
         <SidebarLink name="จัดการผู้ใช้งาน" className="font-bold text-gray-800" />
        <div className="ml-4 space-y-2">
          <SidebarLinkLogo nameLogo="กำหนดสิทธิ์" className="text-sm text-gray-600 hover:text-gray-800" to="/AssetSummary" />
        </div>
