        ...
        {assets.map((asset,index) => (
          <tr key={asset.id} className="hover:bg-gray-50 transition ease-in-out">
            ...
            <td>
             ...
             <td> <button className="bg-gray-300 hover:bg-gray-400 text-xs text-gray-700 rounded-lg px-3 py-1 text-sm" onClick={() => handleSubInsert(asset.id)}>พัสดุย่อย</button>            </td>
          </tr>
        ))}
      </tbody>
    </table>
